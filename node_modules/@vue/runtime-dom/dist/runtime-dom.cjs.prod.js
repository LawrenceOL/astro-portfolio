...
function defineCustomElement(options, hydate) {
    ...
    const attrKeys = rawKeys.map(shared.hyphenate);
    const propKeys = rawKeys.map(shared.camelize);
...
class VueElement extends BaseClass {
    ...
    attributeChangedCallback(name, _oldValue, newValue) {
        if (this._attrKeys.includes(name)) {
            this._setProp(shared.camelize(name), shared.toNumber(newValue), false);
        }
    }
    connectedCallback() {
