...
export declare function isMemoSame(prev: any[], next: any[]): boolean;
export { isProxy }
export { isReactive }
export { isReadonly }
export { isRef }
